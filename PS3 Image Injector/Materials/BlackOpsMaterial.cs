...
namespace PS3_Image_Injector {
    class BlackOpsMaterial : IMaterial {
        static TMAPI PS3 = new TMAPI();

        static readonly UInt32 ASSET_IMAGE_COUNT = 3657;
        static readonly UInt32 ASSET_IMAGE_START = 0xE58C74;
        static readonly UInt32 ASSET_IMAGE_SIZE = 0x70;
        ...
        public BlackOpsMaterial(UInt32 Pointer) {
            this.Pointer = Pointer;

            this.Name = PS3.Ext.ReadString(PS3.Ext.ReadUInt32(this.Pointer + 0x68));
            this.Buffer = PS3.Ext.ReadUInt32(this.Pointer + 0x2C);
        ...
        public static void Populate(MainForm mainForm) {
            ...
            for (uint i = 0; i < ASSET_IMAGE_COUNT; i++) {
                ...
                uint StringName = PS3.Ext.ReadUInt32(ptr + 0x68);
                if (StringName != 0) {
                    IMaterial material = new BlackOpsMaterial(ptr);

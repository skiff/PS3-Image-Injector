...
namespace PS3_Image_Injector {
    public class GhostsMaterial102 : IMaterial {
        static TMAPI PS3 = new TMAPI();

        static readonly UInt32 ASSET_IMAGE_COUNT = 3238;
        static readonly UInt32 ASSET_IMAGE_START = 0x21AA2BC;
        ...
        public GhostsMaterial102(UInt32 Pointer) {
        ...
        public static void Populate(MainForm mainForm) {
            ...
            for (uint i = 0; i < ASSET_IMAGE_COUNT; i++) {
                ...
                if (StringName != 0) {
                    IMaterial material = new GhostsMaterial102(ptr);
